...
if [[ "$MODE" == "slurm" ]]; then
    ...
    echo "Logs: /projects/p32349/speech_synthesis/logs/train_${JID}.out"
    echo "W&B:  https://wandb.ai"

elif [[ "$MODE" == "interactive" ]]; then
    LATEST=$(ls -t /projects/p32349/speech_synthesis/checkpoints/step_*.pt 2>/dev/null | head -n1 || true)
    RESUME_FLAG=""
